	...
	<div id="fh5co-wrapper">
		<div id="fh5co-page">
			...
			<div class="fh5co-hero">
				...
				<div class="fh5co-cover" data-stellar-background-ratio="0.5" style="background-image: url(images/cover_bg_1.png);">
					<div class="desc">
						<div class="container">
							<div class="row">
					...
					<form action="proses.php?aksi=tambah" method="post" enctype="multipart/form-data">
						<div class="row animate-box">
							<div class="col-md-6">
								...
								<p>Wonderful Yogyakarta merupakan platform online yang menyediakan layanan reservasi travel khusus untuk daerah Kota Yogyakarta. Kami menawarkan banyak destinasi wisata menarik yang tentunya akan menjadi pilihan terbaik bagi anda.</p>
								<ul class="contact-info">
									<li><i class="icon-location-pin"></i>Jalan Donokitri No.29</li>
									<li><i class="icon-phone2"></i>+6285155050023</li>
									<li><i class="icon-mail"></i><a href="#">gojogjakarta@gmail.com</a></li>
									<li><i class="icon-instagram"></i><a href="#">gojogjakarta.id</a></li>
								</ul>
							</div>
							<div class="col-md-6">
								<div class="row">
